...
public class ServiceReadinessCheck implements HealthCheck {
    ...
    private static final String readinessCheck = ItemResource.class.getSimpleName() + " Readiness Check";

    @Inject
    @ConfigProperty(name = "eu_getmangos_item_service_inMaintenance")
